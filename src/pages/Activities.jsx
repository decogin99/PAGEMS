                    ...
                    <div className="max-w-2xl mx-auto"> {/* Reduced max-width for Instagram-like feed */}
                        ...
                        <div className="space-y-6">
                            {activities.map((activity) => (
                                <div key={activity.id} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-sm overflow-hidden`}>
                                    {/* Post Header */}
                                    <div className="p-4 flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p className={`font-medium text-sm ${darkMode ? 'text-white' : 'text-gray-900'}`}>{activity.author}</p>
                                                <p className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>{activity.date}</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="px-4 pt-2 pb-4">
                                        ...
                                        <div className="mt-2">
                                            <p className={`text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>{activity.likes} likes</p>
