...
const Sidebar = ({ isOpen, onClose, forceOpenReportDropdown }) => {
    ...
    const filteredReportViews = permissions.dailyReportView === 'All'
        ...
        : reportViews.filter(view => {
            // Extract the department name from the component name (e.g., 'Report_IT' -> 'IT')
            const viewName = view.component.replace('Report_', '');
            return permissions.dailyReportView === viewName;
        });
    ...
    const navigation = [
        ...
        },
        {
            ...
            hasDropdown: true,
            isDropdownOpen: reportDropdownOpen,
            toggleDropdown: () => setReportDropdownOpen(!reportDropdownOpen),
            dropdownItems: filteredReportViews
        },
        {
            name: 'CarBooking',
            path: '/carbooking',
