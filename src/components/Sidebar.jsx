...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const navigation = [
        ...
        {
            name: 'Announcements', path: '/PAGEMS/announcements', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        {
            name: 'Activities', path: '/PAGEMS/activities', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        {
            name: 'Leave', path: '/PAGEMS/leave', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        {
            name: 'CarBooking', path: '/PAGEMS/carbooking', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
