...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const navigation = [
        {
            name: 'Dashboard', path: '/PAGEMS/dashboard', icon: (
        ...
        {
            name: 'Employees', path: '/PAGEMS/Employees', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        {
            name: 'Reports', path: '/PAGEMS/reports', icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    return (
        <>
            <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 shadow-lg ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 border-t border-gray-200">
                        <button
                            className="flex items-center w-full px-4 text-md font-medium text-gray-600 rounded-lg hover:bg-gray-50 hover:text-[#0054A6]">
